...
logging.basicConfig(filename=f'logs/csv/csv_{time_now_filename}.log',format='%(asctime)s %(message)s', datefmt='%m/%d/%Y %I:%M:%S %p',level=logging.DEBUG)
logging.info("Export CSV Begin")
