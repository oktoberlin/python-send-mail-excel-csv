...
'''
worksheet_dailyRecap = workbook.add_worksheet('DAILY RECAP')
...
worksheet_dailyRecap.set_column(0,0,20)
worksheet_dailyRecap.set_column(2,8,5)
worksheet_dailyRecap.set_column(9,9,0.5)
worksheet_dailyRecap.set_column(10,15,5)
worksheet_dailyRecap.set_column(16,16,0.5)
worksheet_dailyRecap.set_column(17,17,5)

worksheet_dailyRecap.write('A2:A2','Date',None)
worksheet_dailyRecap.merge_range('D2:I2','20 FT',None)
worksheet_dailyRecap.merge_range('K2:P2','40 FT',None)
worksheet_dailyRecap.write('R2:R2','45 FT',None)
worksheet_dailyRecap.merge_range('S2:S3','TEU',None)

worksheet_dailyRecap.write('C3:C3','COND',None)
worksheet_dailyRecap.write('D3:D3','GP',None)
worksheet_dailyRecap.write('E3:E3','HC',None)
worksheet_dailyRecap.write('F3:F3','OT',None)
worksheet_dailyRecap.write('G3:G3','RF',None)
worksheet_dailyRecap.write('H3:H3','FR',None)
worksheet_dailyRecap.write('I3:I3','FL',None)
worksheet_dailyRecap.write('K3:K3','GP',None)
worksheet_dailyRecap.write('L3:L3','HC',None)
worksheet_dailyRecap.write('M3:M3','OT',None)
worksheet_dailyRecap.write('N3:N3','RH',None)
worksheet_dailyRecap.write('O3:O3','FR',None)
worksheet_dailyRecap.write('P3:P3','FL',None)
worksheet_dailyRecap.write('R3:R3','HC',None)
